...
export async function seedAchievements(prismaClient: PrismaClient) {
  const achievements = [
    // ========================================
    // STREAK CATEGORY - Consistency badges
    // ========================================
    {
      slug: "first-step",
      title: "First Step",
      description: "Solve a problem for 1 day",
      iconName: "Flame",
      iconEmoji: "🔥",
      xpReward: 25,
      criteria: JSON.stringify({ type: "streak", days: 1 }),
      rarity: "common",
      category: "streak",
      order: 1,
    },
    ...
    },
    {
      ...
      iconEmoji: "🏆",
      xpReward: 5000,
      criteria: JSON.stringify({ type: "streak", days: 365 }),
      rarity: "legendary",
      category: "streak",
      order: 6,
    },
    ...
    // ========================================
    // COMPLETION CATEGORY - Problem solving badges
    // ========================================
    {
      slug: "first-blood",
      title: "First Blood",
    ...
    },
    {
      ...
      iconEmoji: "🚀",
      xpReward: 100,
      criteria: JSON.stringify({ type: "problems_solved", count: 10 }),
      rarity: "common",
      category: "completion",
      order: 2,
    },
    {
      ...
      iconEmoji: "🧩",
      xpReward: 250,
      criteria: JSON.stringify({ type: "problems_solved", count: 25 }),
      rarity: "rare",
      category: "completion",
      order: 3,
    },
    {
      ...
      iconEmoji: "🎯",
      xpReward: 500,
      criteria: JSON.stringify({ type: "problems_solved", count: 50 }),
      rarity: "rare",
      category: "completion",
      order: 4,
    },
    {
      ...
      iconEmoji: "💎",
      xpReward: 1000,
      criteria: JSON.stringify({ type: "problems_solved", count: 100 }),
      rarity: "epic",
      category: "completion",
      order: 5,
    },
    {
      slug: "completionist",
      title: "Completionist",
      description: "Solve all available problems",
      iconName: "CheckCircle2",
      iconEmoji: "👑",
      xpReward: 2500,
      criteria: JSON.stringify({ type: "problems_solved_all" }),
      rarity: "legendary",
      category: "completion",
      order: 6,
    },
    ...
    // ========================================
    // MASTERY CATEGORY - Pattern mastery badges
    // ========================================
    {
      slug: "pattern-pioneer",
      title: "Pattern Pioneer",
      description: "Complete all problems in 1 pattern",
    ...
    {
      slug: "multi-pattern",
      title: "Multi-Pattern Master",
      description: "Complete all problems in 3 patterns",
      iconName: "GraduationCap",
      iconEmoji: "📚",
      xpReward: 500,
      criteria: JSON.stringify({ type: "pattern_complete", count: 3 }),
      rarity: "epic",
      category: "mastery",
      order: 2,
    },
    {
      slug: "pattern-pro",
      title: "Pattern Pro",
      description: "Complete all problems in 10 patterns",
      iconName: "GraduationCap",
      iconEmoji: "🎓",
      xpReward: 1500,
      criteria: JSON.stringify({ type: "pattern_complete", count: 10 }),
      rarity: "legendary",
      category: "mastery",
      order: 3,
    },
    {
      slug: "grand-master",
      title: "Grand Master",
      description: "Complete all patterns",
      iconName: "GraduationCap",
      iconEmoji: "🏛️",
      xpReward: 3000,
      criteria: JSON.stringify({ type: "pattern_complete_all" }),
      rarity: "legendary",
      category: "mastery",
      order: 4,
    },
    {
      ...
      iconEmoji: "🟢",
      xpReward: 300,
      criteria: JSON.stringify({ type: "difficulty_complete", difficulty: "easy" }),
      rarity: "rare",
      category: "mastery",
      order: 5,
    },
    {
      ...
      iconEmoji: "🟡",
      xpReward: 750,
      criteria: JSON.stringify({ type: "difficulty_complete", difficulty: "medium" }),
      rarity: "epic",
      category: "mastery",
      order: 6,
    },
    {
      ...
      iconEmoji: "🔴",
      xpReward: 1500,
      criteria: JSON.stringify({ type: "difficulty_complete", difficulty: "hard" }),
      rarity: "legendary",
      category: "mastery",
      order: 7,
    },
    ...
    // ========================================
    // SPEED CATEGORY - Fast solving badges
    // ========================================
    {
      slug: "quick-thinker",
      title: "Quick Thinker",
      ...
      iconEmoji: "⚡",
      xpReward: 75,
      criteria: JSON.stringify({ type: "speed_solve", minutes: 5 }),
      rarity: "rare",
      category: "speed",
      order: 1,
    },
    {
      slug: "speed-demon",
      title: "Speed Demon",
      description: "Solve 5 problems in under 5 minutes each",
      iconName: "Zap",
      iconEmoji: "🏎️",
      xpReward: 300,
      criteria: JSON.stringify({ type: "speed_solve_count", count: 5, minutes: 5 }),
      rarity: "epic",
      category: "speed",
      order: 2,
    },
    {
      ...
      iconEmoji: "⚡",
      xpReward: 500,
      criteria: JSON.stringify({ type: "speed_solve_hard", minutes: 10 }),
      rarity: "legendary",
      category: "speed",
      order: 3,
    },
    {
      ...
      iconEmoji: "🔥",
      xpReward: 150,
      criteria: JSON.stringify({ type: "daily_solve", count: 5 }),
      rarity: "rare",
      category: "speed",
      order: 4,
    },
    {
      ...
      iconEmoji: "🏃",
      xpReward: 400,
      criteria: JSON.stringify({ type: "daily_solve", count: 10 }),
      rarity: "epic",
      category: "speed",
      order: 5,
    },
    ...
    // ========================================
    // SPECIAL CATEGORY - Fun/unique badges
    // ========================================
    {
      slug: "night-owl",
      title: "Night Owl",
      description: "Solve a problem between 12am and 5am",
      iconName: "Star",
      iconEmoji: "🦉",
      xpReward: 100,
      criteria: JSON.stringify({ type: "time_range", startHour: 0, endHour: 5 }),
      rarity: "rare",
      category: "special",
      order: 1,
    },
    {
      ...
      iconEmoji: "🐦",
      xpReward: 100,
      criteria: JSON.stringify({ type: "time_range", startHour: 5, endHour: 7 }),
      rarity: "rare",
      category: "special",
      order: 2,
    },
    {
      ...
      iconEmoji: "🎮",
      xpReward: 200,
      criteria: JSON.stringify({ type: "weekend_solve", count: 10 }),
      rarity: "rare",
      category: "special",
      order: 3,
    },
    {
      ...
      iconEmoji: "🌐",
      xpReward: 250,
      criteria: JSON.stringify({ type: "languages_used", count: 3 }),
      rarity: "epic",
      category: "special",
      order: 4,
    },
    {
      ...
      iconEmoji: "💫",
      xpReward: 150,
      criteria: JSON.stringify({ type: "comeback", days: 7 }),
      rarity: "rare",
      category: "special",
      order: 5,
    },
    ...
    // ========================================
    // MILESTONE CATEGORY - Level & XP badges
    // ========================================
    {
      slug: "level-5",
      title: "Rising Star",
      ...
      iconEmoji: "⭐",
      xpReward: 100,
      criteria: JSON.stringify({ type: "level", level: 5 }),
      rarity: "common",
      category: "milestone",
      order: 1,
    },
    {
      ...
      iconEmoji: "🌟",
      xpReward: 250,
      criteria: JSON.stringify({ type: "level", level: 10 }),
      rarity: "rare",
      category: "milestone",
      order: 2,
    },
    {
      ...
      iconEmoji: "💫",
      xpReward: 500,
      criteria: JSON.stringify({ type: "level", level: 25 }),
      rarity: "epic",
      category: "milestone",
      order: 3,
    },
    {
      ...
      iconEmoji: "👑",
      xpReward: 1000,
      criteria: JSON.stringify({ type: "level", level: 50 }),
      rarity: "legendary",
      category: "milestone",
      order: 4,
    },
    ...
    },
    {
      ...
      iconEmoji: "💎",
      xpReward: 150,
      criteria: JSON.stringify({ type: "xp", amount: 5000 }),
      rarity: "rare",
      category: "milestone",
      order: 6,
    },
    {
      ...
      iconEmoji: "🏅",
      xpReward: 300,
      criteria: JSON.stringify({ type: "xp", amount: 10000 }),
      rarity: "epic",
      category: "milestone",
      order: 7,
    },
    {
      ...
      iconEmoji: "🏆",
      xpReward: 1000,
      criteria: JSON.stringify({ type: "xp", amount: 50000 }),
      rarity: "legendary",
      category: "milestone",
      order: 8,
    },
  ...
  console.log("✅ Achievements seeded (30+ badges across 6 categories)");
}
